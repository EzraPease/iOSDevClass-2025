...
print(forwards(name1: "Ezra", name2: "Alison"))
...
let friendsAndFamily = ["Ezra", "Lizzy", "Benson", "Alison", "James", "Mathew"]
...
let sortedCollection2 = friendsAndFamily.sorted(by: { (name1: String, name2: String) in
    return name1 < name2
})
...
let sortedCollection3 = friendsAndFamily.sorted(by: < )
