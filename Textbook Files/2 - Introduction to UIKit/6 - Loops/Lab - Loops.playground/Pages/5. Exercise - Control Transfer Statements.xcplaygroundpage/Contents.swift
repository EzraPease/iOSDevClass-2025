...
var states: [String: String] = ["California": "Sacramento", "Texas": "Austin", "Utah": "Salt Lake City", "Florida": "Tallahassee"]
let myHome = ["Utah"]

for (state, capital) in states {
    print("The state is \(state) which has the capital of \(capital)")
    if myHome.contains(state) {
