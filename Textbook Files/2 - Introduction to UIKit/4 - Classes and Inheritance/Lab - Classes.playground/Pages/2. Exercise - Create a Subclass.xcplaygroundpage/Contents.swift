...
class Fighter: Spaceship {
    ...
    func fire() {
        if remainingFirePower > 0 {
            ...
            print("You don't have any more fire power!")
        }
    }
}
...
//print(falcon.weapon)
//Because weapon is part of a subclass of falcon. The subclass inherits properties but the superclass does not inherit from its subclasses
