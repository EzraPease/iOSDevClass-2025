...
print(somePlace.longitue)

//:  Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
somePlace.latitude = 51.514004
somePlace.longitue = 0.125226
print(somePlace.latitude, somePlace.longitue)
...
favoriteBook.title = "To give a mouse a cookie"
favoriteBook.author = "Redacted"
favoriteBook.pages = 20
