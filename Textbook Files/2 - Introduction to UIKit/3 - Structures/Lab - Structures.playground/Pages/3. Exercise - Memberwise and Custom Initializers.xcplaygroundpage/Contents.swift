...
print("Latitue: \(somePlace.latitude) | Longitude: \(somePlace.longitude)")
...
var favoriteBook = Book(title: "Give a mouse a cookie", author: "Redacted", pages: 30, price: 14.99)
print("My favorite book is \(favoriteBook.title)! It has \(favoriteBook.pages) pages, costs $\(favoriteBook.price), and was written by \(favoriteBook.author)")
