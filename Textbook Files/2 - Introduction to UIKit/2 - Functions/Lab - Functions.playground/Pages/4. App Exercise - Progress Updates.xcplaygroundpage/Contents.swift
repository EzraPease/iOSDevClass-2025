...
func progressUpdate(steps: Int, goal: Int) {
    ...
    if stepsDouble < goalDouble * 0.1 {
        print("You're off to a good start")
    }
    else if stepsDouble < goalDouble * 0.5 {
        print("You're almost halfway there!")
    }
    else if stepsDouble < goalDouble * 0.9 {
        print("You're over halfway there!")
    }
    else if stepsDouble < goalDouble {
        print("You're almost there!!!")
    }
    else {
        print("You're surpassed your goal! Well done.")
    }
    
    
}
progressUpdate(steps: 3210, goal: 10000)
...
pacing(currentDistance: 100, totalDistance: 90, currentTime: 100, goalTime: 18)
