 ...
 */
var walkingChallenges: [String] = ["Walk 3 miles a day", "Walk 5 miles a week"]
var runningChallenges: [String] = ["Run 5 miles a day", "Run uphill for 2 miles"]
...
var currentChallenges = [walkingChallenges[1], runningChallenges[0]]
...
if currentChallenges.isEmpty {
    print("Please commit to at least 1 challenge")
        ...
        print("The challenge you have chosen is \(currentChallenges)")
    }
